...
{% include image.html
            ...
            caption="The user login page of [Codecademy](https://www.codecademy.com/)." %}

{% include image.html
            img="project5-courses.png"
            caption="[Codecademy](https://www.codecademy.com/)'s courses page." %}
...
{% include image.html
            ...
            caption="The homepage of [USA Today](http://www.usatoday.com/)." %}

{% include image.html
            img="project5-travel.png"
            caption="The Travel section of [USA Today](http://www.usatoday.com/)." %}
